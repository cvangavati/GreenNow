...
| Data minimization | Review profile, verification-request, location, and media retention needs. Restrict access to exact location and organization-verification data where community visibility is not required. | Production policies match the intended visibility of each field. |
